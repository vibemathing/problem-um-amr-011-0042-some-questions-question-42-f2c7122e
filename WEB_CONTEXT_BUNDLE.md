...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0042-some-questions-question-42-f2c7122e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0042-df252a82f02c",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0042"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does every residually finite property-(T) group have rank gradient zero?",
      "version": 1
    },
    "title": "Some Questions — Question 42",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a26a5fef365bbee73f9480bcb475a6234d7261add2519fa9db1e9ff6623b32c5"
}
```
